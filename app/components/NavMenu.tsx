...
const NavMenu = () => {
  ...
  return (
    <nav className="sticky top-0 w-full z-50 mx-auto px-4 sm:px-6 lg:px-8 bg-[rgba(227,224,220,0.75)] font-serif">
      <div className="flex items-center justify-between h-12 md:h-16">
      <Link
        href="/"
        className="hover:bg-black/10 md:px-3 py-2 rounded-md text-[22px] md:text-[32px] text-[#5a321e]"
      >
        Mathilde Cudeville
      </Link>
