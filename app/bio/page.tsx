...
export default async function Bio() {
  return (
    <div className="h-full">
      <NavMenu />
      <div className="bg-[rgba(227,224,220,0.85)] md:pt-20 min-h-screen p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 md:mx-12">
          ...
          <div className="leading-relaxed text-lg lg:pr-4 col-span-4">
            ...
            <p>
              C’est en la voyant prendre des photos artistiques de notre quinta, située dans la vallée du Douro, que j’ai réalisé quel type de photographe elle était. <span className="font-semibold italic">Mathilde absorbe le monde qui l’entoure</span> et le restitue en lui donnant une touche poétique très personnelle. Elle se dilue dans le décor avant d’en livrer les éléments les plus insolites qui sont souvent les plus parlants.
            </p>
            <p>
            ...
            <p>
              Il en va de même de son rapport à l’humain. C’est en amorçant une collaboration photo-poésie sur <span className="font-semibold italic">le mode onirique que l’étendue de l’imaginaire de Mathilde m’est apparu, sans limites.</span> Notre rêverie en commun a engendré des clichés improbables, sans rapport apparents, tels qu’un phare Saint-pierre-et-miquelonais, un homme nu dans une forêt ou une tente touarègue…
            </p>
            <p>
          ...
          <div className=" leading-relaxed text-lg lg:pl-4 col-span-4">
            ...
            <p>
              Pour parler de la forme, <span className="font-semibold italic">la pratique artistique de Mathilde s’articule autour de la photographie argentique.</span> Ses travaux oscillent entre photographie d’ambiance et photographie plasticienne, et ils sont souvent exposés dans des lieux inattendus, à son image.
            </p>
            <p>
              J’invite les amoureux de la poésie, de l’intimisme et de la singularité à y croiser le regard de Mathilde.
            </p>
            <p className="font-bold font-serif text-xl">Michel Le Roux, poète et ami</p>
          </div>
        </div>
      </div>
      <Footer />
